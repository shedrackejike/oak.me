      ...
      >
        ...
        >
          <Box h="27vh" w={{ base: '50%', lg: '11%', xl: '11%' }}>
            <Box fontSize={'18px'} textColor="#0354C2" fontWeight={'bold'}>
              Product
            </Box>{' '}
            <br />
          ...
          <Box h="27vh" w={{ base: '50%', lg: '15%', xl: '15%' }}>
            <Box fontSize={'15PX'} textColor="#0354C2" fontWeight={'bold'}>
              Existing Customers
            </Box>{' '}
            <br />
          ...
          <Box
            minH={{ base: '10vh', lg: '27vh', xl: '27vh' }}
            w={{ base: '100%', lg: '20%', xl: '20%' }}
          >
            <Box
              mt={{ base: '5%', lg: '5%', xl: '20%' }}
              display={'flex'}
              h="10vh"
              w={'100%'}
        ...
        <Flex
          justifyContent={{ xl: 'space-between' }}
          flexDirection={{ base: 'column', lg: 'flex', xl: 'column' }}
          w={{ base: '100%', lg: '90%', xl: '100%' }}
          alignItems={{ base: 'center', lg: 'center', xl: 'flex' }}
          mt="7"
        >
          <Box
            alignItems={{ base: 'center', lg: 'flex', xl: 'flex-start' }}
            w={{ base: '50%', lg: '90%', xl: '100%' }}
          >
            <Image
          ...
          >
            <Text
              w={{ base: '90%', lg: '100%', xl: '43%' }}
              textAlign={{ base: 'center', lg: 'center', xl: 'flex-start' }}
              fontSize={{ base: '14px', lg: '20%px', xl: '13px' }}
            >
              © Oak Engage 2022. All rights reserved. <br />
              View our website pri vacy policy here and our application privacy
              policy here.
            </Text>
            <Box
              minH={'13vh'}
              w={{ base: '100%', lg: '30%', xl: '30%' }}
              alignItems={{ base: 'center', lg: 'flex', xl: 'flex-end' }}
            >
              <Image
                w="fit-content"
