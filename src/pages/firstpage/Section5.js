    ...
    <Flex mt={'20'}>
      ...
      >
        <Box minH="50vh" w={{ base: '100%', lg: '50%', xl: '45%' }}>
          ...
          <br />
          <Box>
            Oak cuts through the noise and stops your employees being overloaded
            with <br />
            irrelevant information. You can spend less time worrying about how{' '}
            <br />
            employees are receiving your messages and more time making the
            content
            <br />
