  ...
  return (
    <Flex mt={'20'}>
      ...
      >
        ...
        <Box minH="50vh" w={{ base: '100%', lg: '50%', xl: '45%' }}>
          <Box fontSize={'17px'} fontWeight="bold" textColor={'#0354C2'}>
            Connect colleagues. Create communities. <br />
            Champion change.
          </Box>{' '}
          <br />
          <Box>
            Oak allows you to form two-way communication with your employees.{' '}
            <br />
            This ensures your people have the information they need, when <br />
            they need it, driving productivity and performance. Empowered
            employees <br />
